...
Ship an auditable free vault people can try and review. Treat manager import wizards, Recovery Kit polish, and full LAN incremental sync as **follow-on** work—not launch claims. See [public-alpha-roadmap.md](./public-alpha-roadmap.md).
